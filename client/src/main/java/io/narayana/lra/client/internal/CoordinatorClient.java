...
/**
 * MicroProfile REST Client interface for LRA Coordinator operations.
...
public interface CoordinatorClient {
    ...
    Response getNestedLRAStatus(@PathParam("NestedLraId") String nestedLraId);
    ...
    Response forgetNestedLRA(@PathParam("NestedLraId") String nestedLraId);
}
