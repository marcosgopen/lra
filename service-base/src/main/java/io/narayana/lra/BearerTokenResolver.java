...
public final class BearerTokenResolver {
    ...
    public static String resolveFromCdi() {
        try {
            ...
            // Off the request thread (async LRA start, recovery, callbacks): container up but no
            // request scope backs JsonWebToken. Expected here, so trace only; resolution falls
            // through to the client property.
